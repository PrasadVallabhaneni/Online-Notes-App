...
$message .= "http://prasadvallabhaneni.offyoucode.co.uk/Online%20Notes%20App/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'OnlineNotesApp@gmail.com')){
